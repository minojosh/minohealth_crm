...
export default function Home() {
  ...
  const handleButtonClick = () => {
    // Using push instead of direct assignment for proper navigation
    router.push('/appointment-manager');
  };
    ...
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10 min-h-[80vh]">
      ...
      >
        ...
        >
          ...
          {/* <motion.button 
            className="px-6 py-3 bg-white border border-gray-300 text-gray-600 rounded-full font-semibold hover:shadow-lg"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
          >
            Learn More
